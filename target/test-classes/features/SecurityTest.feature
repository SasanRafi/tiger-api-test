...
Scenario: generate token with valid username and passwrod.
...
Scenario: generate token with invalid username and validpasswrod.
Given url 'https://tek-insurance-api.azurewebsites.net'
And path '/api/token'
...
Scenario: generate token with valid username and invalid passwrod.
Given url 'https://tek-insurance-api.azurewebsites.net'
And path '/api/token'
